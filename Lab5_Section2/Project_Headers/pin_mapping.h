 ...
 * @version   1.2.0
 * @brief     Pin declarations for FRDM_K20D50M
 *
 * *****************************
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: ADC0_SE0             = ADC0_DP0 (A10)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   1: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   3: ADC0_SE3             = ADC0_DP3 (A8)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   4: ADC0_SE4b            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   5: ADC0_SE5b            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   6: ADC0_SE6b            = PTD5 (A3)                      */  { PortDInfo,  GPIOD_BasePtr,  5,       PORT_PCR_MUX(0)|defaultPcrValue  },
         /*   7: ADC0_SE7b            = PTD6 (A2)                      */  { PortDInfo,  GPIOD_BasePtr,  6,       PORT_PCR_MUX(0)|defaultPcrValue  },
         ...
         /*  19: ADC0_SE19            = ADC0_DM0 (A11)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  20: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  21: ADC0_SE21            = ADC0_DM3 (A9)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  22: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  23: ADC0_SE23            = ADC0_SE23 (A7)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
   };
...
#define USBDM_ADC0_INFODP_IS_DEFINED
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
            /*   0: ADC0_DP0             = ADC0_DP0 (A10)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
            /*   1: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   3: ADC0_DP3             = ADC0_DP3 (A8)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
      };
...
#define USBDM_ADC0_INFODM_IS_DEFINED
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
            /*   0: ADC0_DM0             = ADC0_DM0 (A11)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
            /*   1: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   3: ADC0_DM3             = ADC0_DM3 (A9)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
      };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: CMP0_IN2             = PTC8 (D4)                      */  { PortCInfo,  GPIOC_BasePtr,  8,       PORT_PCR_MUX(0)|defaultPcrValue  },
         /*   3: CMP0_IN3             = PTC9 (D23)                     */  { PortCInfo,  GPIOC_BasePtr,  9,       PORT_PCR_MUX(0)|defaultPcrValue  },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   3: CMP1_IN3             = ADC0_SE23 (A7)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   4: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   5: CMP1_IN5             = VREF_OUT (A6)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   6: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   7: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   6: FTM0_CH6             = PTA1 (D5)                      */  { PortAInfo,  GPIOA_BasePtr,  1,       PORT_PCR_MUX(3)|defaultPcrValue  },
         /*   7: FTM0_CH7             = PTA2 (D9/LED_BLUE)             */  { PortAInfo,  GPIOA_BasePtr,  2,       PORT_PCR_MUX(3)|defaultPcrValue  },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: I2C0_SCL             = PTB0 (A5/ACC_SCL)              */  { PortBInfo,  GPIOB_BasePtr,  0,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   1: I2C0_SDA             = PTB1 (A4/ACC_SDA)              */  { PortBInfo,  GPIOB_BasePtr,  1,       PORT_PCR_MUX(2)|defaultPcrValue  },
   };
...
#endif
      PORTB->GPCLR = pcrValue|PORT_PCR_MUX(2)|PORT_GPCLR_GPWE(0x0003UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: VDD1                 = VDD1 (VDD1)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   2: VDD2                 = VDD2 (VDD2)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   3: VDD3                 = VDD3 (VDD3)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   4: VDDA                 = VDDA (VDDA)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   5: VOUT33               = VOUT33 (VOUT33)                */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   6: VREFH                = VREFH (VREFH)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   7: VREFL                = VREFL (VREFL)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   8: VREGIN               = VREGIN (VREGIN)                */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   9: VSS1                 = VSS1 (VSS1)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  10: VSS2                 = VSS2 (VSS2)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  11: VSS3                 = VSS3 (VSS3)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  12: VSSA                 = VSSA (VSSA)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: SPI0_SCK             = PTD1 (D13)                     */  { PortDInfo,  GPIOD_BasePtr,  1,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   1: SPI0_SIN             = PTD3 (D12)                     */  { PortDInfo,  GPIOD_BasePtr,  3,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   2: SPI0_SOUT            = PTD2 (D11)                     */  { PortDInfo,  GPIOD_BasePtr,  2,       PORT_PCR_MUX(2)|defaultPcrValue  },
...
#endif
      PORTD->GPCLR = pcrValue|PORT_PCR_MUX(2)|PORT_GPCLR_GPWE(0x000EUL);
   }
   ...
   static void clearPCRs() {
      ...
      enablePortClocks(PORTD_CLOCK_MASK);
#endif
      PORTD->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0xEU);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: VREF_OUT             = VREF_OUT (A6)                  */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
   };
...
using Adc_A1               = const USBDM::Adc0::Channel<15>;
...
using Ftm_D6               = const USBDM::Ftm0::Channel<2>;
using Ftm_LED_RED          = const USBDM::Ftm0::Channel<2>;
using Ftm_D7               = const USBDM::Ftm0::Channel<3>;
using Ftm_D24              = const USBDM::Ftm1::Channel<1>;
/** 
 * End group FTM_Group
 * @}
 */
 ...
 *  VREFH                    | VREFH                                       | VREFH                     | -       
 *  VREFL                    | VREFL                                       | VREFL                     | -       
 *  VREF_OUT                 | VREF_OUT/CMP1_IN5/CMP0_IN5                  | A6                        | Vref output       
